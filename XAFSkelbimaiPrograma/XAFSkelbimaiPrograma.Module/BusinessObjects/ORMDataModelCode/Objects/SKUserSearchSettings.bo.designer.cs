...
namespace XAFSkelbimaiPrograma.Module.BusinessObjects.ORMDataModelCode.Objects
{
    ...
    public partial class SKUserSearchSettings : DevExpress.Persistent.BaseImpl.BaseObject
    {
        ...
        [RuleRequiredField(DefaultContexts.Save)]public XAFSkelbimaiPrograma.Module.BusinessObjects.ORMDataModelCode.Classificators.SKPlugin Plugin
        {
            get
            {
                return _plugin;
        ...
        {
            DLCEmployee currentUser =
                Session.FindObject<DLCEmployee>(CriteriaOperator.Parse("Oid = ?", SecuritySystem.CurrentUserId));
            SKUser = currentUser;
            base.OnSaving();
        }
    }
