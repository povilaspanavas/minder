...
namespace XAFSkelbimaiPrograma.Web
{
    ...
    public partial class XAFSkelbimaiProgramaAspNetApplication : WebApplication
    { // http://documentation.devexpress.com/#Xaf/DevExpressExpressAppWebWebApplicationMembersTopicAll
        ...
        private void XAFSkelbimaiProgramaAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e)
        {
#if EASYTEST
			e.Updater.Update();
			e.Handled = true;
    ...
    "AFSkelbimaiPrograma";
            ...
            // 
            this.ApplicationName = "XAFSkelbimaiPrograma";
