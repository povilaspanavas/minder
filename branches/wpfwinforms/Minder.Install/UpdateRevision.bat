...
RevisionUpdater\RevisionUpdater.exe --TagFile VersionFiles\REVISION --ReplaceRevision ..\Minder\version.template --InsertRevision-- ..\Minder\version.version --enc Default
